...
def create_dialog_slack():
    ...
    frappe.response["text"] = "Please fill the form so I can upload your issue to the system, once submitted I will notify you..."   # just empty response (modal opens separately)
